# Tracker index (regenerated 2026-09-09T01:26:59Z — do not edit)
...
- TASK-0040 [P1][task][patch] Strike the direct-edit path: groups/idols leave EDIT_CONFIG, and every surface that assumed it is reconciled  (scope:src/lib/edit,src/app/records,src/app/api/admin,src/components,src/lib/db,tests/offline,tests/live,tests/http from:inbox:2026-09-09-vision-amendment.md)
...
Totals — blocked:3, built:1, claimed:2, done:5, open:20, qa:2. Archived: 124.
