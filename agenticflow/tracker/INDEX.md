# Tracker index (regenerated 2026-09-09T05:55:59Z — do not edit)
...
- BUG-0101 [P2][bug][M2] A refusal on a record's LAST field draws its app-voice half outside the table's clipping container - the half BUG-0098 shipped is the half that disappears  (scope:src/components/EditableCell.tsx,src/components/edit-cell-layout.ts,src/components/records/record-fields.tsx,tests/offline/ui/editable-cell.test.ts,tests/offline/records/page.test.ts from:BUG-0098)
...
Totals — built:1, done:48, open:3, qa:5, wont_fix:1. Archived: 124.
