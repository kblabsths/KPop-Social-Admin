# Tracker index (regenerated 2026-09-02T17:08:38Z — do not edit)
...
## built
- BUG-0028 [P2][bug][M1] The write-path guard bans the admin_locked column NAME, so the provenance display spec §8 requires cannot be built  (scope:tests/offline/edit @builder-52 from:TASK-0011)
...
Totals — blocked:2, built:1, done:58, open:10. Archived: 0.
