# Tracker index (regenerated 2026-09-15T05:21:14Z — do not edit)
...
## claimed
- BUG-0223 [P3][bug][patch] Settlement readiness asks about the TABLE only, so a half-installed world offers an override whose save 503s  (scope:src/lib/db/verdict.ts,src/app/records/[table]/[id]/page.tsx,tests/offline/edit/records.test.ts,tests/offline/edit/route.test.ts,tests/live/edit.live.test.ts @builder-323 from:BUG-0215)
...
Totals — blocked:1, claimed:1, done:92, open:5. Archived: 252.
