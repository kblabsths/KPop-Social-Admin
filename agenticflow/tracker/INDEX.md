# Tracker index (regenerated 2026-09-09T06:00:12Z — do not edit)
...
- BUG-0102 [P2][bug][M2] the close's picker stays live while a settlement is in flight, and drops the row it is clicked with  (scope:src/components/review/close/form.tsx,tests/offline/review-item/link-actions.test.ts from:TASK-0056)
...
Totals — claimed:1, done:49, open:3, qa:4, reopened:1, wont_fix:1. Archived: 124.
