# Tracker index (regenerated 2026-09-12T00:45:42Z — do not edit)
...
## built
- BUG-0213 [P2][bug][-] The attribution corpus carries a 2-line paste block, so the sibling allocating ITS next code reddens the offline suite  (scope:tests/offline/handoff/settle-review-item.test.ts @builder-313 from:BUG-0207)
...
Totals — built:1, done:80, open:4, qa:1. Archived: 252.
