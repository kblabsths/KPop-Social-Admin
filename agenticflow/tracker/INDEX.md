# Tracker index (regenerated 2026-09-09T05:19:38Z — do not edit)
...
- BUG-0096 [P2][bug][M2] The close sits 3,500px below the evidence it closes, so the operator scrolls four screenfuls to act  (scope:src/app/queues/[reviewItemId]/page.tsx,tests/offline/review-item/page.test.ts from:designer:early-walk)
- BUG-0097 [P2][bug][-] The entity picker keeps every option clickable while a choice is saving: a second click sends a second override for the same field  (scope:src/components/records/entity-picker.tsx,tests/offline/records/entity-picker.test.ts from:TASK-0055)
...
Totals — built:1, done:43, open:6, qa:3, wont_fix:1. Archived: 124.
