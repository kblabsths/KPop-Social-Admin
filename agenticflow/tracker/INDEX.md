# Tracker index (regenerated 2026-09-02T21:17:27Z — do not edit)
...
## claimed
- BUG-0035 [P2][bug][-] The state classifier grades a surface green while it carries an ERROR card the classifier did not account for  (scope:tests/live/parity.ts,tests/offline/live-guard.test.ts @builder-64 from:TASK-0032)
...
Totals — blocked:2, claimed:1, done:72, open:2. Archived: 0.
