# Tracker index (regenerated 2026-09-02T19:53:18Z — do not edit)
...
- BUG-0034 [P2][bug][M1] events record page shows venue as a bare uuid with no way through: less than the Browse row the operator clicked  (scope:src/components/records,src/app/records,tests/offline/records from:TASK-0029)
...
Totals — blocked:1, built:1, done:68, open:5, qa:1. Archived: 0.
