# Tracker index (regenerated 2026-09-11T14:29:37Z — do not edit)
...
- BUG-0194 [P2][bug][-] /sources' settled-values figures are narrowed to one source and no word on the page says so  (scope:src/components/sources/trends.tsx,src/app/sources/page.tsx,src/lib/gauges/settled-values.ts,tests/offline/sources/page.test.ts,tests/live/sources.live.test.ts from:TASK-0073)
...
- TASK-0060 [P3][task][patch] Route the last two source-name renderers through lib/sources/names.ts — and close that class  (deps:TASK-0073 scope:src/components/sources/registry-table.tsx,src/components/sources/trends.tsx,src/lib/sources/names.ts,tests/offline/sources/names.test.ts,tests/offline/sources/page.test.ts from:qa:BUG-0159)

## built
- BUG-0192 [P2][bug][M3] A narrowing clause names what a facet DID, not that it is set — /claims' chip clause  (deps:TASK-0072 scope:src/lib/url/narrowing.ts,src/lib/claims/filters.ts,src/app/claims/page.tsx,tests/offline/url/narrowing.test.ts,tests/offline/claims,tests/live/claims.live.test.ts @builder-292 from:BUG-0191)

Totals — built:1, done:50, open:6. Archived: 252.
