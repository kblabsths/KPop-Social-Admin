# Tracker index (regenerated 2026-09-02T06:41:55Z — do not edit)
...
- TASK-0004 [P1][task][M1] Design tokens and the UI primitives every surface is built from  (deps:TASK-0001 scope:src/app/globals.css,src/components/ui,src/components/evidence,src/lib/format.ts,tests/offline/ui,tests/offline/format.test.ts)
...
## built
- TASK-0002 [P1][task][M1] The staging data layer: the client seam, DbResult, and the table-name constants  (deps:TASK-0001 scope:src/lib/db,tests/offline/db,tests/fixtures @builder-3)
...
Totals — blocked:5, built:1, done:4, open:26. Archived: 0.
