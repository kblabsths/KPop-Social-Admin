# Tracker index (regenerated 2026-09-02T20:57:16Z — do not edit)
...
## built
- TASK-0032 [P1][task][M1] Live oracles must name the page's state kind: an ERROR page may not pass and an EMPTY page may not fail  (deps:BUG-0027 scope:tests/live,tests/offline/live-guard.test.ts,src/components/ui @builder-63 from:TASK-0012)
...
Totals — blocked:1, built:1, done:72, open:2. Archived: 0.
