# Tracker index (regenerated 2026-09-09T03:24:28Z — do not edit)
...
- TASK-0050 [P1][task][M2] The data_conflict item's three verdict actions, one typed decision each  (deps:TASK-0049 scope:src/components/review/close/conflict-actions.tsx,tests/offline/review-item/conflict-actions.test.ts)
...
- BUG-0085 [P2][bug][M2] the verdict log renders a present-but-blank note as an empty cell, not the mandated dash  (from:TASK-0058)
...
- TASK-0059 [P2][task][M2] A settled review item's detail carries its own verdict inline  (deps:TASK-0058,TASK-0049(unmet:1) scope:src/app/queues/[reviewItemId]/page.tsx,src/lib/db/verdict.ts,src/lib/db/review-item.ts,src/components/review/close/slot.tsx,tests/offline/review-item/verdict-inline.test.ts,tests/live/review-item.live.test.ts)
...
Totals — blocked:2, done:23, open:13, qa:2, wont_fix:1. Archived: 124.
