# Tracker index (regenerated 2026-09-11T14:38:27Z — do not edit)
...
- BUG-0194 [P2][bug][M3] /sources' settled-values figures are narrowed to one source and no word on the page says so  (scope:src/lib/db/gauges.ts,src/lib/gauges/settled-values.ts,src/app/sources/page.tsx,src/components/sources/trends.tsx,tests/offline/gauges/settled-values.test.ts,tests/offline/gauges/bounded.test.ts,tests/offline/sources/page.test.ts,tests/offline/absence/pages.test.ts,tests/live/sources.live.test.ts from:TASK-0073)
...
Totals — done:50, open:6, qa:1. Archived: 252.
