# Tracker index (regenerated 2026-09-15T05:05:07Z — do not edit)
...
## claimed
- BUG-0229 [P2][bug][-] A count that is a whole number but not a number of ROWS (negative, or beyond exact representation) is published as a figure  (scope:src/lib/db/result.ts,tests/offline/db/result.test.ts @builder-329 from:BUG-0228)
...
Totals — blocked:1, claimed:1, done:91, open:5. Archived: 252.
