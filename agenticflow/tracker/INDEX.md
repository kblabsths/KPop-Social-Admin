# Tracker index (regenerated 2026-09-09T04:21:37Z — do not edit)
...
- BUG-0091 [P2][bug][M2] the settle route accepts a text-carrying supply_value for a reference fact — the reference rule is guarded only by the courtesy layer  (scope:src/lib/verdict/decision.ts,tests/offline/review-item/conflict-actions.test.ts from:qa:BUG-0087)
...
Totals — built:2, claimed:2, done:32, open:8, qa:2, wont_fix:1. Archived: 124.
