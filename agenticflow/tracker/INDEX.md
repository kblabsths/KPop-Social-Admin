# Tracker index (regenerated 2026-09-15T06:02:58Z — do not edit)
...
## built
- BUG-0230 [P3][bug][-] A host total of "-0" is published as the figure "-0" — a count of no rows wearing a minus sign  (scope:src/lib/format.ts,src/lib/db/result.ts,tests/offline/format.test.ts,tests/http/absence.http.test.ts @builder-330 from:BUG-0229)

## qa
- BUG-0225 [P3][bug][patch] The sibling-code reader answers from three grammars it cannot actually read — state its bar once instead of a fifth instance  (deps:TASK-0080 scope:tests/handoff,tests/offline/handoff/extract.ts @builder-325 from:BUG-0220)
...
Totals — blocked:1, built:1, done:93, open:3, qa:1. Archived: 252.
