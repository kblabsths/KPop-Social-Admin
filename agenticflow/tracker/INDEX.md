# Tracker index (regenerated 2026-09-02T09:34:19Z — do not edit)

## open
- BUG-0010 [P1][bug][-] Browse's Sources column names superseded and sourceless provenance decisions  (scope:src/lib/db/browse.ts,src/lib/browse/rows.ts,tests/offline/browse from:TASK-0015)
...
## claimed
- TASK-0017 [P1][task][M1] The edit config map and the one PATCH route that obeys it  (deps:TASK-0005,TASK-0002,TASK-0026,TASK-0027 scope:src/lib/edit,src/app/api/admin/records/[table]/[id]/route.ts,src/lib/db/records.ts,tests/offline/edit,tests/http/edit.http.test.ts @builder-19)
...
Totals — blocked:5, claimed:1, done:17, open:23, reopened:1. Archived: 0.
