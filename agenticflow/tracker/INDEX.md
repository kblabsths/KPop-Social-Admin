# Tracker index (regenerated 2026-09-09T18:48:56Z — do not edit)
...
## claimed
- BUG-0141 [P1][bug][M2] /queues ignores the source_id the Sources page links it with: another source's item renders as that source's review items  (scope:src/app/queues/page.tsx,src/components/queues,src/components/ui/dropped-params.tsx,src/components/ui/index.ts,src/lib/url/dropped-params.ts,src/lib/review/queue-filters.ts,src/lib/review/shapes.ts,src/lib/db/review-items.ts,src/lib/sources/routes.ts,src/lib/claims/filters.ts,src/app/claims/page.tsx,tests/offline/queues/page.test.ts,tests/offline/queues/filters.test.ts,tests/offline/claims/page.test.ts,tests/offline/claims/filters.test.ts,tests/offline/review/shapes.test.ts,tests/offline/review/review-items.test.ts,tests/offline/review/one-place.test.ts,tests/offline/sources/page.test.ts,tests/live/queues.live.test.ts,tests/live/sources.live.test.ts,tests/fixtures/rows.ts @builder-208 from:verifier)
...
Totals — blocked:1, claimed:1, done:95, open:1, wont_fix:1. Archived: 124.
