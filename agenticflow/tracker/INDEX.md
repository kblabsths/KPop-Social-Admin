# Tracker index (regenerated 2026-09-15T05:46:47Z — do not edit)

## open
- BUG-0230 [P3][bug][-] A host total of "-0" is published as the figure "-0" — a count of no rows wearing a minus sign  (scope:src/lib/format.ts,src/lib/db/result.ts,tests/offline/format.test.ts,tests/http/absence.http.test.ts from:BUG-0229)
...
Totals — blocked:1, claimed:1, done:93, open:4. Archived: 252.
