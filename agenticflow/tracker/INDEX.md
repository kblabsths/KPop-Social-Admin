# Tracker index (regenerated 2026-09-09T10:44:37Z — do not edit)
...
- BUG-0115 [P2][bug][M2] The Dashboard's attention cards put a chip inside the link: the severity badge dissolves into the card under the pointer  (scope:src/app/page.tsx,src/components/ui/stat-card.tsx,tests/offline/dashboard/page.test.ts from:BUG-0113)
...
Totals — blocked:1, built:1, done:65, open:4, reopened:1, wont_fix:1. Archived: 124.
