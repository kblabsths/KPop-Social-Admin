# Tracker index (regenerated 2026-09-12T00:59:17Z — do not edit)

## open
- BUG-0220 [P2][bug][-] The registry reader takes a narrower declaration grammar than the sibling's own parser, so a typing pass next door reddens npm test and a single-quoted claim passes  (scope:tests/offline/handoff/settle-review-item.test.ts from:BUG-0213)
...
Totals — claimed:1, done:81, open:5, qa:1. Archived: 252.
