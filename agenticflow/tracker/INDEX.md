# Tracker index (regenerated 2026-09-09T21:55:18Z — do not edit)

## open
- BUG-0148 [P2][bug][patch] The verdict block's observation id is still hand-faced — the one call site DEBT-0011's sweep left outside the identifier primitive  (scope:src/components/review/close/slot.tsx,tests/offline/review-item/verdict-inline.test.ts from:DEBT-0011)
...
Totals — blocked:1, built:1, done:104, open:4, reopened:1, wont_fix:1. Archived: 124.
