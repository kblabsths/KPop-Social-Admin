# Tracker index (regenerated 2026-09-15T02:52:25Z — do not edit)

## open
- BUG-0224 [P2][bug][patch] A host that 404s with zero bytes makes /claims say 'No claims waiting' over a read that failed, beside a sentence about this app's own call site  (scope:src/lib/db/result.ts,tests/http/absence.http.test.ts,tests/http/postgrest-stub.ts,tests/offline/db/result.test.ts from:BUG-0210)
...
Totals — blocked:1, built:1, done:84, open:8. Archived: 252.
