# Tracker index (regenerated 2026-09-10T01:27:32Z — do not edit)
...
## claimed
- BUG-0157 [P3][bug][patch] The folded-records table prints the dash-meaning line with no dash on screen: a record's own em-dash reference is explained as "a value this row does not carry"  (scope:src/components/review/evidence-cells.tsx,tests/offline/review-item/page.test.ts @builder-234 from:BUG-0156)
...
Totals — blocked:1, claimed:1, done:117, open:2, qa:1, wont_fix:1. Archived: 124.
