# Tracker index (regenerated 2026-09-02T18:59:11Z — do not edit)
...
## claimed
- BUG-0032 [P2][bug][M1] Two offline tests crash (ENOENT) when they walk src/ while the layering suite's probe is in flight  (scope:tests/offline/claims/read.test.ts,tests/offline/browse/views.test.ts,tests/offline/toolchain.test.ts,tests/offline/db/layering.test.ts @builder-58 from:BUG-0029)
...
Totals — blocked:1, claimed:1, done:64, open:9. Archived: 0.
