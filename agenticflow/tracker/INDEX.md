# Tracker index (regenerated 2026-09-04T05:55:41Z — do not edit)

## open
- BUG-0076 [P2][bug][M1] Queues item page: an address that is not a review-item id is reported as a failed database read, not as no such item  (scope:src/app/queues/[reviewItemId]/page.tsx,tests/offline/review-item/page.test.ts from:BUG-0068)
...
Totals — built:1, claimed:1, done:119, open:6. Archived: 0.
