# Tracker index (regenerated 2026-09-15T04:01:52Z — do not edit)
...
## built
- BUG-0227 [P2][bug][-] A host answering 200 with a body that is not a row set crashes every surface with a 500 instead of refusing  (scope:src/lib/db/result.ts,tests/http/absence.http.test.ts,tests/http/postgrest-stub.ts,tests/offline/db/result.test.ts @builder-327 from:BUG-0224)
...
Totals — blocked:1, built:1, done:87, open:7. Archived: 252.
