# Tracker index (regenerated 2026-09-09T03:55:26Z — do not edit)

## open
- BUG-0087 [P1][bug][M2] data_conflict on a reference field offers a free-text supply_value, so a venue NAME settles a venue_id fact  (scope:src/components/review/close/conflict-actions.tsx,tests/offline/review-item/conflict-actions.test.ts from:qa:TASK-0050)
...
## built
- TASK-0051 [P1][task][M2] The signal item's two dispositions: fixed, and wont_fix with its required note  (deps:TASK-0049 scope:src/components/review/close/signal-actions.tsx,tests/offline/review-item/signal-actions.test.ts @builder-145)
...
Totals — built:1, claimed:3, done:28, open:9, qa:1, wont_fix:1. Archived: 124.
