# Tracker index (regenerated 2026-09-11T14:50:58Z — do not edit)

## open
- BUG-0195 [P1][bug][M3] The run branch fails tsc: BUG-0194's pin annotates a cheerio node as Cheerio<never>  (deps:BUG-0194(unmet:1) scope:tests/offline/sources/page.test.ts from:BUG-0192)
...
Totals — built:1, done:52, open:5. Archived: 252.
