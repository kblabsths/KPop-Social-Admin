    ...
    <div>
      ...
      {totalPages > 1 && (
        <div className="flex justify-center gap-2 mt-4">
          {page > 1 && (
            <Link
              href={`/alerts?page=${page - 1}${typeFilter ? `&type=${typeFilter}` : ""}${severityFilter ? `&severity=${severityFilter}` : ""}${resolvedFilter ? `&resolved=${resolvedFilter}` : ""}`}
